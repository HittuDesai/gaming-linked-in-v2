...
export function Comment({ comment, postID }) {
	...
	const commentTimeInDateFormat = new Date(
		commentTime.seconds * 1000 + commentTime.nanoseconds / 1000000
	);
	const commentTimeToDisplay = commentTimeInDateFormat.toLocaleDateString(
		undefined,
	...
	const handleLikeComment = () => {
		...
		const commentDocumentReference = doc(
			db,
	...
	return (
		...
		>
			...
			>
				{isCommentLiked ? (
					<FavoriteIcon
						sx={{ color: "red", width: "1rem", height: "1rem" }}
					/>
				) : (
					<FavoriteBorderIcon
