...
export function UploadModal() {
	...
	useEffect(() => {
		if (currentStep === "Upload Media")
			if (file === null) setDialogActionDisabled(true);
			else setDialogActionDisabled(false);
		else if (currentStep === "Post Description")
			if (caption === "") setDialogActionDisabled(true);
			else setDialogActionDisabled(false);
	...
	return (
		<Dialog fullWidth maxWidth="xs" open={wantsToUpload}>
			<DialogTitle
				fontSize="small"
				variant="overline"
				sx={{ textAlign: "center" }}
